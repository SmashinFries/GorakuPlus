import { MediaTag, MediaType, UserAnimeListCollectionQuery } from '@/store/services/anilist/generated-anilist';
...
export const sortListTabs = (listNames: string[], tabOrder: string[], listCounts: { [key: string]: number }) => {
