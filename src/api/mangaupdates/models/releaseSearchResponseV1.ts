 ...
 */
import type { ReleaseSearchResponseV1ResultsItem } from './releaseSearchResponseV1ResultsItem';

export interface ReleaseSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ReleaseSearchResponseV1ResultsItem[];
  total_hits?: number;
}
