...
export type SeriesModelUpdateV1RelatedSeriesItemRelationType = typeof SeriesModelUpdateV1RelatedSeriesItemRelationType[keyof typeof SeriesModelUpdateV1RelatedSeriesItemRelationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelUpdateV1RelatedSeriesItemRelationType = {
  Prequel: 'Prequel',
  Sequel: 'Sequel',
