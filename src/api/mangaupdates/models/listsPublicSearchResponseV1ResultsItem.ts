 ...
 */
import type { ListsPublicSearchResponseV1ResultsItemMetadata } from './listsPublicSearchResponseV1ResultsItemMetadata';

export type ListsPublicSearchResponseV1ResultsItem = {
  chapter?: number;
  metadata?: ListsPublicSearchResponseV1ResultsItemMetadata;
  series_id?: number;
  series_title?: string;
  volume?: number;
};
