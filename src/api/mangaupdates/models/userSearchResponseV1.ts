 ...
 */
import type { UserSearchResponseV1ResultsItem } from './userSearchResponseV1ResultsItem';

export interface UserSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: UserSearchResponseV1ResultsItem[];
  total_hits?: number;
}
