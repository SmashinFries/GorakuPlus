 ...
 */
import type { SeriesCommentSearchResponseV1ResultsItem } from './seriesCommentSearchResponseV1ResultsItem';

export interface SeriesCommentSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: SeriesCommentSearchResponseV1ResultsItem[];
  total_hits?: number;
}
