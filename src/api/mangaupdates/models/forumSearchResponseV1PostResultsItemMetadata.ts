 ...
 */
import type { ForumSearchResponseV1PostResultsItemMetadataForumInfo } from './forumSearchResponseV1PostResultsItemMetadataForumInfo';
import type { ForumSearchResponseV1PostResultsItemMetadataTopicStats } from './forumSearchResponseV1PostResultsItemMetadataTopicStats';

export type ForumSearchResponseV1PostResultsItemMetadata = {
  forum_info?: ForumSearchResponseV1PostResultsItemMetadataForumInfo;
  is_subscribed?: boolean;
  my_latest_post_in_topic?: number;
  topic_stats?: ForumSearchResponseV1PostResultsItemMetadataTopicStats;
};
