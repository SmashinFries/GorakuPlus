 ...
 */
import type { SeriesSearchResponseV1ResultsItemMetadata } from './seriesSearchResponseV1ResultsItemMetadata';
import type { SeriesModelSearchV1 } from './seriesModelSearchV1';

export type SeriesSearchResponseV1ResultsItem = {
  hit_title?: string;
  metadata?: SeriesSearchResponseV1ResultsItemMetadata;
