 ...
 */
import type { ListsSimilarUsersResponseV1UsersItem } from './listsSimilarUsersResponseV1UsersItem';

export interface ListsSimilarUsersResponseV1 {
  total_hits?: number;
  users?: ListsSimilarUsersResponseV1UsersItem[];
}
