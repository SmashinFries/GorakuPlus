 ...
 */
import type { ListsModelUpdateV1Options } from './listsModelUpdateV1Options';
import type { ListsModelUpdateV1Type } from './listsModelUpdateV1Type';

export interface ListsModelUpdateV1 {
  description?: string;
  icon?: string;
  options?: ListsModelUpdateV1Options;
  title?: string;
  type?: ListsModelUpdateV1Type;
}
