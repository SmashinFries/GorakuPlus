 ...
 */
import type { ListsModelV1 } from './listsModelV1';
import type { ListsPublicSearchResponseV1ResultsItem } from './listsPublicSearchResponseV1ResultsItem';

export interface ListsPublicSearchResponseV1 {
  list?: ListsModelV1;
  page?: number;
  per_page?: number;
  results?: ListsPublicSearchResponseV1ResultsItem[];
  total_hits?: number;
}
