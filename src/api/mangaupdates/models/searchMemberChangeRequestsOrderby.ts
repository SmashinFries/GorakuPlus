...
export type SearchMemberChangeRequestsOrderby = typeof SearchMemberChangeRequestsOrderby[keyof typeof SearchMemberChangeRequestsOrderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SearchMemberChangeRequestsOrderby = {
  score: 'score',
  time: 'time',
} as const;
