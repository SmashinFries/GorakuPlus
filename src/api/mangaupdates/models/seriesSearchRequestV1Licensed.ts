...
export type SeriesSearchRequestV1Licensed = typeof SeriesSearchRequestV1Licensed[keyof typeof SeriesSearchRequestV1Licensed];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesSearchRequestV1Licensed = {
  yes: 'yes',
  no: 'no',
} as const;
