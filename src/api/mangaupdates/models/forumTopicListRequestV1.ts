 ...
 */
import type { ForumTopicListRequestV1Orderby } from './forumTopicListRequestV1Orderby';

export interface ForumTopicListRequestV1 {
  orderby?: ForumTopicListRequestV1Orderby;
  page?: number;
  perpage?: number;
}
