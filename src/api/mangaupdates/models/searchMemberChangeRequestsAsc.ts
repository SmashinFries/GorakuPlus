...
export type SearchMemberChangeRequestsAsc = typeof SearchMemberChangeRequestsAsc[keyof typeof SearchMemberChangeRequestsAsc];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SearchMemberChangeRequestsAsc = {
  asc: 'asc',
  desc: 'desc',
} as const;
