 ...
 */
import type { SeriesCommentModerationResponseV1ResultsItem } from './seriesCommentModerationResponseV1ResultsItem';

export interface SeriesCommentModerationResponseV1 {
  page?: number;
  per_page?: number;
  results?: SeriesCommentModerationResponseV1ResultsItem[];
  total_hits?: number;
}
