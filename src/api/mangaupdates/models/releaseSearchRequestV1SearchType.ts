...
export type ReleaseSearchRequestV1SearchType = typeof ReleaseSearchRequestV1SearchType[keyof typeof ReleaseSearchRequestV1SearchType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ReleaseSearchRequestV1SearchType = {
  series: 'series',
  regular: 'regular',
} as const;
