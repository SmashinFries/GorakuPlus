 ...
 */
import type { AuthorsModelUpdateV1Admin } from './authorsModelUpdateV1Admin';
import type { AuthorsModelUpdateV1AssociatedItem } from './authorsModelUpdateV1AssociatedItem';
import type { BirthdayModelV1 } from './birthdayModelV1';
import type { AuthorsModelUpdateV1Bloodtype } from './authorsModelUpdateV1Bloodtype';
import type { AuthorsModelUpdateV1Gender } from './authorsModelUpdateV1Gender';
import type { AuthorsModelUpdateV1Social } from './authorsModelUpdateV1Social';
import type { AuthorsModelUpdateV1Status } from './authorsModelUpdateV1Status';
import type { StatusDateModelV1 } from './statusDateModelV1';

export interface AuthorsModelUpdateV1 {
  actualname?: string;
  admin?: AuthorsModelUpdateV1Admin;
  associated?: AuthorsModelUpdateV1AssociatedItem[];
  birthday?: BirthdayModelV1;
  birthplace?: string;
  bloodtype?: AuthorsModelUpdateV1Bloodtype;
  comments?: string;
  gender?: AuthorsModelUpdateV1Gender;
  name?: string;
  social?: AuthorsModelUpdateV1Social;
  status?: AuthorsModelUpdateV1Status;
