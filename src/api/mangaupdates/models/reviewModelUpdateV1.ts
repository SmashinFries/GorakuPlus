 ...
 */
import type { ReviewModelUpdateV1Admin } from './reviewModelUpdateV1Admin';
import type { ReviewModelUpdateV1Review } from './reviewModelUpdateV1Review';

export interface ReviewModelUpdateV1 {
  admin?: ReviewModelUpdateV1Admin;
  body?: string;
  review?: ReviewModelUpdateV1Review;
  series_title?: string;
  title?: string;
}
