 ...
 */
import type { UserModelSearchV1ProfileUpgrade } from './userModelSearchV1ProfileUpgrade';

export type UserModelSearchV1Profile = {
  upgrade?: UserModelSearchV1ProfileUpgrade;
};
