...
export type ListsBulkAddModelV1Priority = typeof ListsBulkAddModelV1Priority[keyof typeof ListsBulkAddModelV1Priority];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListsBulkAddModelV1Priority = {
  High: 'High',
  Low: 'Low',
} as const;
