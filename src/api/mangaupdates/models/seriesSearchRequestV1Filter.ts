...
export type SeriesSearchRequestV1Filter = typeof SeriesSearchRequestV1Filter[keyof typeof SeriesSearchRequestV1Filter];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesSearchRequestV1Filter = {
  scanlated: 'scanlated',
  completed: 'completed',
  oneshots: 'oneshots',
