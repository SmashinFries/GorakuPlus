 ...
 */
import type { ConvoMessageSearchResponseV1ResultsItem } from './convoMessageSearchResponseV1ResultsItem';

export interface ConvoMessageSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ConvoMessageSearchResponseV1ResultsItem[];
  total_hits?: number;
}
