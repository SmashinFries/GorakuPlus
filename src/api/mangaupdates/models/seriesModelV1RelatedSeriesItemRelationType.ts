...
export type SeriesModelV1RelatedSeriesItemRelationType = typeof SeriesModelV1RelatedSeriesItemRelationType[keyof typeof SeriesModelV1RelatedSeriesItemRelationType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelV1RelatedSeriesItemRelationType = {
  Prequel: 'Prequel',
  Sequel: 'Sequel',
