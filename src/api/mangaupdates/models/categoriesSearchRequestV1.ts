 ...
 */
import type { CategoriesSearchRequestV1Orderby } from './categoriesSearchRequestV1Orderby';

export interface CategoriesSearchRequestV1 {
  letter?: string;
  orderby?: CategoriesSearchRequestV1Orderby;
  page?: number;
  perpage?: number;
  search?: string;
}
