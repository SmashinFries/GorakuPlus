 ...
 */
import type { ForumCategoryModelListV1ForumsItem } from './forumCategoryModelListV1ForumsItem';

export interface ForumCategoryModelListV1 {
  category_id?: number;
  forums?: ForumCategoryModelListV1ForumsItem[];
  name?: string;
}
