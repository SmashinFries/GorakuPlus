...
export type SeriesModelV1AuthorsItemType = typeof SeriesModelV1AuthorsItemType[keyof typeof SeriesModelV1AuthorsItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelV1AuthorsItemType = {
  Author: 'Author',
  Artist: 'Artist',
} as const;
