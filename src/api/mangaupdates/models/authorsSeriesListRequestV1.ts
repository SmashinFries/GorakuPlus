 ...
 */
import type { AuthorsSeriesListRequestV1Orderby } from './authorsSeriesListRequestV1Orderby';

export interface AuthorsSeriesListRequestV1 {
  orderby?: AuthorsSeriesListRequestV1Orderby;
}
