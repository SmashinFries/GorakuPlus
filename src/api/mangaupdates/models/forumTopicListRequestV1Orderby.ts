...
export type ForumTopicListRequestV1Orderby = typeof ForumTopicListRequestV1Orderby[keyof typeof ForumTopicListRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ForumTopicListRequestV1Orderby = {
