...
export type ListsModelUpdateV1OptionsSort = typeof ListsModelUpdateV1OptionsSort[keyof typeof ListsModelUpdateV1OptionsSort];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListsModelUpdateV1OptionsSort = {
  title: 'title',
  priority: 'priority',
  date: 'date',
  rating: 'rating',
