 ...
 */
import type { GroupsSeriesListResponseV1SeriesCategoriesItem } from './groupsSeriesListResponseV1SeriesCategoriesItem';
import type { GroupsSeriesListResponseV1SeriesGenresItem } from './groupsSeriesListResponseV1SeriesGenresItem';
import type { GroupsSeriesListResponseV1SeriesTitlesItem } from './groupsSeriesListResponseV1SeriesTitlesItem';

export interface GroupsSeriesListResponseV1 {
  release_frequency?: string;
  series_categories?: GroupsSeriesListResponseV1SeriesCategoriesItem[];
  series_genres?: GroupsSeriesListResponseV1SeriesGenresItem[];
  series_titles?: GroupsSeriesListResponseV1SeriesTitlesItem[];
}
