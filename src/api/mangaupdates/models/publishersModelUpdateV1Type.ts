...
export type PublishersModelUpdateV1Type = typeof PublishersModelUpdateV1Type[keyof typeof PublishersModelUpdateV1Type];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublishersModelUpdateV1Type = {
  'N/A': 'N/A',
  Japanese: 'Japanese',
  English: 'English',
  Korean: 'Korean',
