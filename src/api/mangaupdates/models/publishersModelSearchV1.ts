...
import type { PublishersModelSearchV1Stats } from './publishersModelSearchV1Stats';
import type { PublishersModelSearchV1Type } from './publishersModelSearchV1Type';

export interface PublishersModelSearchV1 {
  added_by?: UserModelSearchV1;
  name?: string;
  publisher_id?: number;
  stats?: PublishersModelSearchV1Stats;
  type?: PublishersModelSearchV1Type;
  url?: string;
}
