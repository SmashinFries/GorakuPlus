 ...
 */
import type { ForumPollModelV1Admin } from './forumPollModelV1Admin';
import type { ForumPollAnswerModelV1 } from './forumPollAnswerModelV1';

export interface ForumPollModelV1 {
  admin?: ForumPollModelV1Admin;
