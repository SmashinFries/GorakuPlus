...
export type UserModelV1ProfileFilterTypesItem = typeof UserModelV1ProfileFilterTypesItem[keyof typeof UserModelV1ProfileFilterTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserModelV1ProfileFilterTypesItem = {
  Artbook: 'Artbook',
  Doujinshi: 'Doujinshi',
  Drama_CD: 'Drama CD',
  Filipino: 'Filipino',
