...
export type SeriesSearchRequestV1Orderby = typeof SeriesSearchRequestV1Orderby[keyof typeof SeriesSearchRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesSearchRequestV1Orderby = {
  score: 'score',
  title: 'title',
  rank: 'rank',
  rating: 'rating',
