 ...
 */
import type { ConvoSearchResponseV1ResultsItem } from './convoSearchResponseV1ResultsItem';

export interface ConvoSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ConvoSearchResponseV1ResultsItem[];
  total_hits?: number;
}
