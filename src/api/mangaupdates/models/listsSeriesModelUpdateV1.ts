 ...
 */
import type { ListsSeriesModelUpdateV1Series } from './listsSeriesModelUpdateV1Series';
import type { ListsSeriesModelUpdateV1Status } from './listsSeriesModelUpdateV1Status';

export interface ListsSeriesModelUpdateV1 {
  list_id?: number;
  priority?: number;
  series: ListsSeriesModelUpdateV1Series;
  status?: ListsSeriesModelUpdateV1Status;
}
