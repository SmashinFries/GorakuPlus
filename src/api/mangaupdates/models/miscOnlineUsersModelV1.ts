 ...
 */
import type { MiscOnlineUsersModelV1UsersItem } from './miscOnlineUsersModelV1UsersItem';

export interface MiscOnlineUsersModelV1 {
  users?: MiscOnlineUsersModelV1UsersItem[];
}
