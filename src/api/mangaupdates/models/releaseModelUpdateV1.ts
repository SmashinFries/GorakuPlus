 ...
 */
import type { ReleaseModelUpdateV1Admin } from './releaseModelUpdateV1Admin';
import type { ReleaseModelUpdateV1GroupsItem } from './releaseModelUpdateV1GroupsItem';
import type { TimeUpdateV1 } from './timeUpdateV1';

export interface ReleaseModelUpdateV1 {
  admin?: ReleaseModelUpdateV1Admin;
  chapter?: string;
  comment?: string;
  download_notes?: string;
  groups?: ReleaseModelUpdateV1GroupsItem[];
  release_date?: string;
