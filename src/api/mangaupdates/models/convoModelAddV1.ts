 ...
 */
import type { ConvoMessageModelUpdateV1 } from './convoMessageModelUpdateV1';
import type { ConvoParticipantModelAddV1 } from './convoParticipantModelAddV1';

export interface ConvoModelAddV1 {
