...
import type { PublishersModelV1Admin } from './publishersModelV1Admin';
import type { PublishersModelV1AssociatedItem } from './publishersModelV1AssociatedItem';
import type { TimeV1 } from './timeV1';
import type { PublishersModelV1Stats } from './publishersModelV1Stats';
import type { PublishersModelV1Type } from './publishersModelV1Type';

export interface PublishersModelV1 {
  added_by?: UserModelSearchV1;
  admin?: PublishersModelV1Admin;
  associated?: PublishersModelV1AssociatedItem[];
  info?: string;
  last_updated?: TimeV1;
  name?: string;
  publisher_id?: number;
  site?: string;
  stats?: PublishersModelV1Stats;
  type?: PublishersModelV1Type;
  url?: string;
}
