...
export type CategoriesSearchRequestV1Orderby = typeof CategoriesSearchRequestV1Orderby[keyof typeof CategoriesSearchRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CategoriesSearchRequestV1Orderby = {
  category: 'category',
  agree: 'agree',
  disagree: 'disagree',
  usage: 'usage',
