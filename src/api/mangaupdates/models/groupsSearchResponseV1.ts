 ...
 */
import type { GroupsSearchResponseV1ResultsItem } from './groupsSearchResponseV1ResultsItem';

export interface GroupsSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: GroupsSearchResponseV1ResultsItem[];
  total_hits?: number;
}
