 ...
 */
import type { SeriesCommentModelUpdateV1Admin } from './seriesCommentModelUpdateV1Admin';

export interface SeriesCommentModelUpdateV1 {
  admin?: SeriesCommentModelUpdateV1Admin;
  content?: string;
  subject?: string;
}
