 ...
 */
import type { ReviewCommentSearchResponseV1ResultsItem } from './reviewCommentSearchResponseV1ResultsItem';

export interface ReviewCommentSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ReviewCommentSearchResponseV1ResultsItem[];
  total_hits?: number;
}
