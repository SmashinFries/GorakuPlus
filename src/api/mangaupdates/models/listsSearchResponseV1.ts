...
import type { ListsSearchResponseV1ResultsItem } from './listsSearchResponseV1ResultsItem';

export interface ListsSearchResponseV1 {
  list?: ListsModelV1;
  page?: number;
  per_page?: number;
  results?: ListsSearchResponseV1ResultsItem[];
  total_hits?: number;
}
