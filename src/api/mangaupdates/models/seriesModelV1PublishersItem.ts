 ...
 */
import type { SeriesModelV1PublishersItemType } from './seriesModelV1PublishersItemType';

export type SeriesModelV1PublishersItem = {
  notes?: string;
  publisher_id?: number;
  publisher_name?: string;
  type?: SeriesModelV1PublishersItemType;
};
