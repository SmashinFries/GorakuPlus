 ...
 */
import type { SeriesModelUpdateV1RelatedSeriesItemRelationType } from './seriesModelUpdateV1RelatedSeriesItemRelationType';

export type SeriesModelUpdateV1RelatedSeriesItem = {
  related_series_id: number;
  relation_type: SeriesModelUpdateV1RelatedSeriesItemRelationType;
};
