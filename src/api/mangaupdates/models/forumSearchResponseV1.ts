 ...
 */
import type { ForumSearchResponseV1PostResultsItem } from './forumSearchResponseV1PostResultsItem';
import type { ForumSearchResponseV1TopicResultsItem } from './forumSearchResponseV1TopicResultsItem';

export interface ForumSearchResponseV1 {
  page?: number;
  per_page?: number;
  post_results?: ForumSearchResponseV1PostResultsItem[];
  topic_results?: ForumSearchResponseV1TopicResultsItem[];
  total_hits?: number;
}
