...
export type ListsModelUpdateV1OptionsShowComment = typeof ListsModelUpdateV1OptionsShowComment[keyof typeof ListsModelUpdateV1OptionsShowComment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListsModelUpdateV1OptionsShowComment = {
  link: 'link',
  text: 'text',
  none: 'none',
} as const;
