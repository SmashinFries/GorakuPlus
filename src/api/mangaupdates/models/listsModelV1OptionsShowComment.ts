...
export type ListsModelV1OptionsShowComment = typeof ListsModelV1OptionsShowComment[keyof typeof ListsModelV1OptionsShowComment];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ListsModelV1OptionsShowComment = {
  link: 'link',
  text: 'text',
  none: 'none',
} as const;
