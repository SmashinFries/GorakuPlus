 ...
 */
import type { ListsModelV1Options } from './listsModelV1Options';
import type { ListsModelV1Type } from './listsModelV1Type';

export interface ListsModelV1 {
  custom?: boolean;
  description?: string;
  icon?: string;
  list_id?: number;
  options?: ListsModelV1Options;
  title?: string;
  type?: ListsModelV1Type;
}
