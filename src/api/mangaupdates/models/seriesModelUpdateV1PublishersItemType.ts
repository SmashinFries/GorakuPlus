...
export type SeriesModelUpdateV1PublishersItemType = typeof SeriesModelUpdateV1PublishersItemType[keyof typeof SeriesModelUpdateV1PublishersItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelUpdateV1PublishersItemType = {
  Original: 'Original',
  English: 'English',
} as const;
