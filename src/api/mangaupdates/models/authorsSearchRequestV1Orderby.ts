...
export type AuthorsSearchRequestV1Orderby = typeof AuthorsSearchRequestV1Orderby[keyof typeof AuthorsSearchRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AuthorsSearchRequestV1Orderby = {
  name: 'name',
  series: 'series',
  score: 'score',
} as const;
