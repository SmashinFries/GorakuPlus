 ...
 */
import type { SeriesModelV1RelatedSeriesItemRelationType } from './seriesModelV1RelatedSeriesItemRelationType';

export type SeriesModelV1RelatedSeriesItem = {
  related_series_id: number;
  related_series_name?: string;
  relation_id?: number;
  relation_type: SeriesModelV1RelatedSeriesItemRelationType;
