 ...
 */
import type { SeriesHistorySearchResponseV1ResultsItem } from './seriesHistorySearchResponseV1ResultsItem';

export interface SeriesHistorySearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: SeriesHistorySearchResponseV1ResultsItem[];
  series_title?: string;
  total_hits?: number;
}
