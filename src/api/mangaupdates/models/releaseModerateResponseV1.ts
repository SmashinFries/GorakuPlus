 ...
 */
import type { ReleaseModerateResponseV1GroupInfoItem } from './releaseModerateResponseV1GroupInfoItem';
import type { ReleaseModerateResponseV1ResultsItem } from './releaseModerateResponseV1ResultsItem';

export interface ReleaseModerateResponseV1 {
  group_info?: ReleaseModerateResponseV1GroupInfoItem[];
  page?: number;
  per_page?: number;
  results?: ReleaseModerateResponseV1ResultsItem[];
  total_hits?: number;
}
