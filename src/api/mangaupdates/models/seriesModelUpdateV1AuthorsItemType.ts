...
export type SeriesModelUpdateV1AuthorsItemType = typeof SeriesModelUpdateV1AuthorsItemType[keyof typeof SeriesModelUpdateV1AuthorsItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelUpdateV1AuthorsItemType = {
  Author: 'Author',
  Artist: 'Artist',
} as const;
