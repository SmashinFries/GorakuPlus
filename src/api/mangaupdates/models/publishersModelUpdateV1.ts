 ...
 */
import type { PublishersModelUpdateV1Admin } from './publishersModelUpdateV1Admin';
import type { PublishersModelUpdateV1AssociatedItem } from './publishersModelUpdateV1AssociatedItem';
import type { PublishersModelUpdateV1Type } from './publishersModelUpdateV1Type';

export interface PublishersModelUpdateV1 {
  admin?: PublishersModelUpdateV1Admin;
  associated?: PublishersModelUpdateV1AssociatedItem[];
  info?: string;
  name?: string;
  site?: string;
  type?: PublishersModelUpdateV1Type;
}
