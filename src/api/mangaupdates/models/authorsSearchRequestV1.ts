 ...
 */
import type { AuthorsSearchRequestV1Orderby } from './authorsSearchRequestV1Orderby';

export interface AuthorsSearchRequestV1 {
  added_by?: number;
  genre?: string[];
  letter?: string;
  orderby?: AuthorsSearchRequestV1Orderby;
  page?: number;
  pending?: boolean;
  perpage?: number;
  search?: string;
