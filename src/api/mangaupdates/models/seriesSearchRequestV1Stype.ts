...
export type SeriesSearchRequestV1Stype = typeof SeriesSearchRequestV1Stype[keyof typeof SeriesSearchRequestV1Stype];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesSearchRequestV1Stype = {
  title: 'title',
