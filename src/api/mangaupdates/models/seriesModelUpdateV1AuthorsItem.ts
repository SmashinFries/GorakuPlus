 ...
 */
import type { SeriesModelUpdateV1AuthorsItemType } from './seriesModelUpdateV1AuthorsItemType';

export type SeriesModelUpdateV1AuthorsItem = {
  name?: string;
  type?: SeriesModelUpdateV1AuthorsItemType;
};
