 ...
 */
import type { PublishersSearchResponseV1ResultsItem } from './publishersSearchResponseV1ResultsItem';

export interface PublishersSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: PublishersSearchResponseV1ResultsItem[];
  total_hits?: number;
}
