 ...
 */
import type { SeriesSearchResponseV1ResultsItemMetadataUserGenreHighlightsItem } from './seriesSearchResponseV1ResultsItemMetadataUserGenreHighlightsItem';
import type { ListsSeriesModelV1 } from './listsSeriesModelV1';

export type SeriesSearchResponseV1ResultsItemMetadata = {
  user_genre_highlights?: SeriesSearchResponseV1ResultsItemMetadataUserGenreHighlightsItem[];
