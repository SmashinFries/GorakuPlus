 ...
 */
import type { ListsSeriesModelV1Series } from './listsSeriesModelV1Series';
import type { ListsSeriesModelV1Status } from './listsSeriesModelV1Status';
import type { TimeV1 } from './timeV1';

export interface ListsSeriesModelV1 {
  list_icon?: string;
  list_id?: number;
  list_type?: string;
  priority?: number;
  series: ListsSeriesModelV1Series;
  status?: ListsSeriesModelV1Status;
  time_added?: TimeV1;
}
