 ...
 */
import type { ReleaseModelV1Admin } from './releaseModelV1Admin';
import type { ReleaseModelV1GroupsItem } from './releaseModelV1GroupsItem';
import type { TimeV1 } from './timeV1';

export interface ReleaseModelV1 {
  admin?: ReleaseModelV1Admin;
  chapter?: string;
  comment?: string;
  download_notes?: string;
  groups?: ReleaseModelV1GroupsItem[];
  id?: number;
  release_date?: string;
  time_added?: TimeV1;
  title?: string;
