...
export type PublishersModelSearchV1Type = typeof PublishersModelSearchV1Type[keyof typeof PublishersModelSearchV1Type];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublishersModelSearchV1Type = {
  'N/A': 'N/A',
  Japanese: 'Japanese',
  English: 'English',
  Korean: 'Korean',
