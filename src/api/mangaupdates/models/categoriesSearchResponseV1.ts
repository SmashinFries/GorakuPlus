 ...
 */
import type { CategoriesSearchResponseV1ResultsItem } from './categoriesSearchResponseV1ResultsItem';

export interface CategoriesSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: CategoriesSearchResponseV1ResultsItem[];
  total_hits?: number;
}
