...
export type PublishersSearchRequestV1Orderby = typeof PublishersSearchRequestV1Orderby[keyof typeof PublishersSearchRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublishersSearchRequestV1Orderby = {
  score: 'score',
  name: 'name',
  series: 'series',
