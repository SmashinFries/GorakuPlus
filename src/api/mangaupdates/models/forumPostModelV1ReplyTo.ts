 ...
 */
import type { ForumPostModelV1ReplyToPostAuthor } from './forumPostModelV1ReplyToPostAuthor';

export type ForumPostModelV1ReplyTo = {
  post_author?: ForumPostModelV1ReplyToPostAuthor;
  post_id?: number;
};
