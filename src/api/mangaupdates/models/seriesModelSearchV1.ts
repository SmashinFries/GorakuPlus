 ...
 */
import type { SeriesModelSearchV1Admin } from './seriesModelSearchV1Admin';
import type { SeriesModelSearchV1GenresItem } from './seriesModelSearchV1GenresItem';
import type { ImageModelV1 } from './imageModelV1';
import type { TimeV1 } from './timeV1';
import type { SeriesModelSearchV1Rank } from './seriesModelSearchV1Rank';
import type { SeriesModelSearchV1Type } from './seriesModelSearchV1Type';

export interface SeriesModelSearchV1 {
  admin?: SeriesModelSearchV1Admin;
  bayesian_rating?: number;
  description?: string;
  genres?: SeriesModelSearchV1GenresItem[];
  image?: ImageModelV1;
  last_updated?: TimeV1;
  latest_chapter?: number;
  rank?: SeriesModelSearchV1Rank;
  rating_votes?: number;
  series_id?: number;
  title?: string;
  type?: SeriesModelSearchV1Type;
  url?: string;
  year?: string;
}
