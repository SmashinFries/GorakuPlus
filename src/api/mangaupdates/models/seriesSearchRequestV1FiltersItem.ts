...
export type SeriesSearchRequestV1FiltersItem = typeof SeriesSearchRequestV1FiltersItem[keyof typeof SeriesSearchRequestV1FiltersItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesSearchRequestV1FiltersItem = {
  scanlated: 'scanlated',
  completed: 'completed',
  oneshots: 'oneshots',
  no_oneshots: 'no_oneshots',
