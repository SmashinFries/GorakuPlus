...
import type { GroupsModelV1Admin } from './groupsModelV1Admin';
import type { GroupsModelV1AssociatedItem } from './groupsModelV1AssociatedItem';
import type { GroupsModelV1Social } from './groupsModelV1Social';

export interface GroupsModelV1 {
  active?: boolean;
  added_by?: UserModelSearchV1;
  admin?: GroupsModelV1Admin;
  associated?: GroupsModelV1AssociatedItem[];
  group_id?: number;
  name?: string;
  notes?: string;
  social?: GroupsModelV1Social;
  url?: string;
}
