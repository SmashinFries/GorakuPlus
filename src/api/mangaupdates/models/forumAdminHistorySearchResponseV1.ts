 ...
 */
import type { ForumAdminHistorySearchResponseV1ResultsItem } from './forumAdminHistorySearchResponseV1ResultsItem';

export interface ForumAdminHistorySearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ForumAdminHistorySearchResponseV1ResultsItem[];
  total_hits?: number;
}
