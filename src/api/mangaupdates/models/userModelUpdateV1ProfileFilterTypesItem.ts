...
export type UserModelUpdateV1ProfileFilterTypesItem = typeof UserModelUpdateV1ProfileFilterTypesItem[keyof typeof UserModelUpdateV1ProfileFilterTypesItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const UserModelUpdateV1ProfileFilterTypesItem = {
  Artbook: 'Artbook',
  Doujinshi: 'Doujinshi',
  Drama_CD: 'Drama CD',
  Filipino: 'Filipino',
