 ...
 */
import type { AuthorsSearchResponseV1ResultsItem } from './authorsSearchResponseV1ResultsItem';

export interface AuthorsSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: AuthorsSearchResponseV1ResultsItem[];
  total_hits?: number;
}
