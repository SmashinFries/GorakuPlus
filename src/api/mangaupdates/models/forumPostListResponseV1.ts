 ...
 */
import type { ForumPostListResponseV1ResultsItem } from './forumPostListResponseV1ResultsItem';

export interface ForumPostListResponseV1 {
  page?: number;
  per_page?: number;
  results?: ForumPostListResponseV1ResultsItem[];
  total_hits?: number;
}
