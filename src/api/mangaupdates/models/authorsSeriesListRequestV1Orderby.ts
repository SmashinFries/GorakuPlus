...
export type AuthorsSeriesListRequestV1Orderby = typeof AuthorsSeriesListRequestV1Orderby[keyof typeof AuthorsSeriesListRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AuthorsSeriesListRequestV1Orderby = {
  title: 'title',
  year: 'year',
} as const;
