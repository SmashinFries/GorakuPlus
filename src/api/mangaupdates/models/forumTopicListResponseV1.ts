 ...
 */
import type { ForumTopicListResponseV1ResultsItem } from './forumTopicListResponseV1ResultsItem';

export interface ForumTopicListResponseV1 {
  page?: number;
  per_page?: number;
  results?: ForumTopicListResponseV1ResultsItem[];
  total_hits?: number;
}
