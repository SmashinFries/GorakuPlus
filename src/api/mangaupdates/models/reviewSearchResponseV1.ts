 ...
 */
import type { ReviewSearchResponseV1ResultsItem } from './reviewSearchResponseV1ResultsItem';

export interface ReviewSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: ReviewSearchResponseV1ResultsItem[];
  total_hits?: number;
}
