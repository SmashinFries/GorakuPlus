...
export type SeriesModelV1PublishersItemType = typeof SeriesModelV1PublishersItemType[keyof typeof SeriesModelV1PublishersItemType];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SeriesModelV1PublishersItemType = {
  Original: 'Original',
  English: 'English',
} as const;
