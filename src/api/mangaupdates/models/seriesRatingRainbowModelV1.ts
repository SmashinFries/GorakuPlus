 ...
 */
import type { SeriesRatingRainbowModelV1RainbowItem } from './seriesRatingRainbowModelV1RainbowItem';

export interface SeriesRatingRainbowModelV1 {
  average_rating?: number;
  rainbow?: SeriesRatingRainbowModelV1RainbowItem[];
}
