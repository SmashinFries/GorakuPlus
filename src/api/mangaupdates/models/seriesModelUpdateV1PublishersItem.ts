 ...
 */
import type { SeriesModelUpdateV1PublishersItemType } from './seriesModelUpdateV1PublishersItemType';

export type SeriesModelUpdateV1PublishersItem = {
  notes?: string;
  publisher_name?: string;
  type?: SeriesModelUpdateV1PublishersItemType;
};
