 ...
 */
import type { UserChangeRequestSearchResponseV1ResultsItem } from './userChangeRequestSearchResponseV1ResultsItem';

export interface UserChangeRequestSearchResponseV1 {
  page?: number;
  per_page?: number;
  results?: UserChangeRequestSearchResponseV1ResultsItem[];
  total_hits?: number;
}
