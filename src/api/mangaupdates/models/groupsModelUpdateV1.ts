 ...
 */
import type { GroupsModelUpdateV1Admin } from './groupsModelUpdateV1Admin';
import type { GroupsModelUpdateV1AssociatedItem } from './groupsModelUpdateV1AssociatedItem';
import type { GroupsModelUpdateV1Social } from './groupsModelUpdateV1Social';

export interface GroupsModelUpdateV1 {
  active?: boolean;
  admin?: GroupsModelUpdateV1Admin;
  associated?: GroupsModelUpdateV1AssociatedItem[];
  name?: string;
  notes?: string;
  social?: GroupsModelUpdateV1Social;
}
