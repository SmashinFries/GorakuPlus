 ...
 */
import type { ListsPublicStatsModelV1GenresItem } from './listsPublicStatsModelV1GenresItem';

export interface ListsPublicStatsModelV1 {
  genres?: ListsPublicStatsModelV1GenresItem[];
}
