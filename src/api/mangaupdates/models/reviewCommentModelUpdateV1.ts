 ...
 */
import type { ReviewCommentModelUpdateV1Admin } from './reviewCommentModelUpdateV1Admin';

export interface ReviewCommentModelUpdateV1 {
  admin?: ReviewCommentModelUpdateV1Admin;
  content?: string;
  rating?: number;
  subject?: string;
}
