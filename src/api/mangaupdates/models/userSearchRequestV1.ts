 ...
 */
import type { UserSearchRequestV1Asc } from './userSearchRequestV1Asc';
import type { UserSearchRequestV1Orderby } from './userSearchRequestV1Orderby';

export interface UserSearchRequestV1 {
  asc?: UserSearchRequestV1Asc;
  letter?: string;
  orderby?: UserSearchRequestV1Orderby;
  page?: number;
  perpage?: number;
  search?: string;
}
