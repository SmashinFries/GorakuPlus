 ...
 */
import type { ReleaseSearchRequestV1Asc } from './releaseSearchRequestV1Asc';
import type { ReleaseSearchRequestV1Orderby } from './releaseSearchRequestV1Orderby';
import type { ReleaseSearchRequestV1SearchType } from './releaseSearchRequestV1SearchType';

export interface ReleaseSearchRequestV1 {
  added_by?: number;
  asc?: ReleaseSearchRequestV1Asc;
  end_date?: string;
  group_id?: number;
  include_metadata?: boolean;
  letter?: string;
  orderby?: ReleaseSearchRequestV1Orderby;
  page?: number;
  pending?: boolean;
  perpage?: number;
  search?: string;
  search_type?: ReleaseSearchRequestV1SearchType;
  start_date?: string;
}
