...
export type ForumSearchRequestV1Method = typeof ForumSearchRequestV1Method[keyof typeof ForumSearchRequestV1Method];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ForumSearchRequestV1Method = {
  fulltext: 'fulltext',
  exact: 'exact',
} as const;
