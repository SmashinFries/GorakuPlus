 ...
 */
import type { ReleaseModelSearchV1GroupsItem } from './releaseModelSearchV1GroupsItem';
import type { TimeV1 } from './timeV1';

export interface ReleaseModelSearchV1 {
  chapter?: string;
  groups?: ReleaseModelSearchV1GroupsItem[];
  id?: number;
  release_date?: string;
  time_added?: TimeV1;
  title?: string;
