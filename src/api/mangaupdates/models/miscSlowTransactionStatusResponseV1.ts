 ...
 */
import type { MiscSlowTransactionStatusResponseV1State } from './miscSlowTransactionStatusResponseV1State';

export interface MiscSlowTransactionStatusResponseV1 {
  done?: number;
  error?: string;
  percent?: number;
  return?: string;
  state?: MiscSlowTransactionStatusResponseV1State;
  total?: number;
}
