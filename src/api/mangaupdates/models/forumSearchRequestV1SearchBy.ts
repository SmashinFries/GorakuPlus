...
export type ForumSearchRequestV1SearchBy = typeof ForumSearchRequestV1SearchBy[keyof typeof ForumSearchRequestV1SearchBy];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ForumSearchRequestV1SearchBy = {
  post: 'post',
  topic: 'topic',
} as const;
