 ...
 */
import type { AvatarModelSearchV1 } from './avatarModelSearchV1';
import type { UserModelSearchV1Profile } from './userModelSearchV1Profile';
import type { UserModelSearchV1Stats } from './userModelSearchV1Stats';
import type { TimeV1 } from './timeV1';

export interface UserModelSearchV1 {
  avatar?: AvatarModelSearchV1;
  folding_at_home?: boolean;
  forum_title?: string;
  profile?: UserModelSearchV1Profile;
  signature?: string;
  stats?: UserModelSearchV1Stats;
  time_joined?: TimeV1;
  url?: string;
  user_group?: string;
