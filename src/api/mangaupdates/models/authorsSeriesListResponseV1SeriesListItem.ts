...
import type { AuthorsSeriesListResponseV1SeriesListItemMetadata } from './authorsSeriesListResponseV1SeriesListItemMetadata';

export type AuthorsSeriesListResponseV1SeriesListItem = {
  genres?: string[];
  last_updated?: TimeV1;
  metadata?: AuthorsSeriesListResponseV1SeriesListItemMetadata;
  series_id?: number;
  title?: string;
  year?: string;
};
