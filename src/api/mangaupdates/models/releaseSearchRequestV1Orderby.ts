...
export type ReleaseSearchRequestV1Orderby = typeof ReleaseSearchRequestV1Orderby[keyof typeof ReleaseSearchRequestV1Orderby];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ReleaseSearchRequestV1Orderby = {
  date: 'date',
  time: 'time',
  title: 'title',
  vol: 'vol',
