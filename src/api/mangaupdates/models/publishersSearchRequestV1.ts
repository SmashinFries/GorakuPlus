 ...
 */
import type { PublishersSearchRequestV1Orderby } from './publishersSearchRequestV1Orderby';

export interface PublishersSearchRequestV1 {
  added_by?: number;
  letter?: string;
  orderby?: PublishersSearchRequestV1Orderby;
  page?: number;
  pending?: boolean;
  perpage?: number;
  search?: string;
