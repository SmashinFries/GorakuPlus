 ...
 */
import type { ReviewModelV1Author } from './reviewModelV1Author';
import type { ReviewModelV1Review } from './reviewModelV1Review';
import type { SeriesModelSearchV1 } from './seriesModelSearchV1';
import type { TimeV1 } from './timeV1';

export interface ReviewModelV1 {
  author?: ReviewModelV1Author;
  body?: string;
  id?: number;
  review?: ReviewModelV1Review;
