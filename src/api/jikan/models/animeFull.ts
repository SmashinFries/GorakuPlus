...
import type { AnimeFullExternalItem } from './animeFullExternalItem';
import type { AnimeImages } from './animeImages';
import type { AnimeFullRating } from './animeFullRating';
import type { AnimeFullRelationsItem } from './animeFullRelationsItem';
import type { AnimeFullSeason } from './animeFullSeason';
import type { AnimeFullStatus } from './animeFullStatus';
import type { AnimeFullStreamingItem } from './animeFullStreamingItem';
import type { AnimeFullTheme } from './animeFullTheme';
import type { Title } from './title';
import type { TrailerBase } from './trailerBase';
import type { AnimeFullType } from './animeFullType';
