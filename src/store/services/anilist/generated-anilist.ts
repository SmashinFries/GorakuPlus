...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    ReviewRating: build.mutation<ReviewRatingMutation, ReviewRatingMutationVariables | void>({
      query: (variables) => ({ document: ReviewRatingDocument, variables })
    }),
