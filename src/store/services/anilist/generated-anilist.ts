...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    UserAnimeListCollection: build.query<UserAnimeListCollectionQuery, UserAnimeListCollectionQueryVariables | void>({
      query: (variables) => ({ document: UserAnimeListCollectionDocument, variables })
    }),
    UserMangaListCollection: build.query<UserMangaListCollectionQuery, UserMangaListCollectionQueryVariables | void>({
