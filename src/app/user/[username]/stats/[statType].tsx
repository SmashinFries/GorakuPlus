		...
		<ScrollView contentContainerStyle={{ justifyContent: 'center', alignItems: 'center' }}>
			...
			>
				<GeneralStatBlock
					icon="television"
					title="Total Anime"
					value={data?.User?.statistics?.anime?.count ?? 0}
				/>
				<GeneralStatBlock
					icon="play"
					title="Episodes Watched"
					value={data?.User?.statistics?.anime?.episodesWatched ?? 0}
				/>
				<GeneralStatBlock
					icon="calendar-month"
					title="Days Watched"
					value={
						((data?.User?.statistics?.anime?.minutesWatched ?? 1) / 60 / 24)?.toFixed(
							2,
						) ?? '???'
					}
				/>
		...
		<ScrollView contentContainerStyle={{ justifyContent: 'center', alignItems: 'center' }}>
			...
			>
				<GeneralStatBlock
					icon="television"
					title="Total Manga"
					value={data?.User?.statistics?.manga?.count ?? 0}
				/>
				<GeneralStatBlock
					icon="play"
					title="Chapters Read"
					value={data?.User?.statistics?.manga?.chaptersRead ?? 0}
				/>
				<GeneralStatBlock
					icon="play"
					title="Volumes Read"
					value={data?.User?.statistics?.manga?.volumesRead ?? 0}
				/>
				<GeneralStatBlock
					icon="timer-sand-full"
