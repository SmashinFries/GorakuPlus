...
export type AnimeExploreQueryVariables = Exact<{
  ...
  nextSeasonYear?: InputMaybe<Scalars['Int']>;
  onList?: InputMaybe<Scalars['Boolean']>;
  isAdult?: InputMaybe<Scalars['Boolean']>;
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    AnimeExplore: build.query<AnimeExploreQuery, AnimeExploreQueryVariables | void>({
      query: (variables) => ({ document: AnimeExploreDocument, variables })
    }),
    MangaExplore: build.query<MangaExploreQuery, MangaExploreQueryVariables | void>({
      query: (variables) => ({ document: MangaExploreDocument, variables })
    }),
    ManhwaExplore: build.query<ManhwaExploreQuery, ManhwaExploreQueryVariables | void>({
      query: (variables) => ({ document: ManhwaExploreDocument, variables })
    }),
    ManhuaExplore: build.query<ManhuaExploreQuery, ManhuaExploreQueryVariables | void>({
      query: (variables) => ({ document: ManhuaExploreDocument, variables })
    }),
    NovelExplore: build.query<NovelExploreQuery, NovelExploreQueryVariables | void>({
      query: (variables) => ({ document: NovelExploreDocument, variables })
    }),
