...
import sauceNaoApi from './services/saucenao/sauceNaoApi';
import { mangadexApi } from './services/mangadex/mangadexApi';
...
const persistedAuth = persistReducer<AuthState, AnyAction>(authPersistConfig, authSlice);
...
export const store = configureStore({
	reducer: {
		...
		[sauceNaoApi.reducerPath]: sauceNaoApi.reducer,
